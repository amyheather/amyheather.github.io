...
### NHS-OA RAP committee

July 2026 onwards.

I am part of the NHS Open Analytics (OA) Reproducible Analytical Pipelines (RAP) Committee.

## Hackathons

### Spring Hackathon: Making Replications Count

4th - 6th May 2026.

Organised by [FORRT (Framework for Open and Reproducible Research Training)](https://forrt.org/) ([GitHub](https://github.com/forrtproject)). I was part of a team developing a tool to automatically extract data from published replication studies. This will support and expand the FORRT Library of Replication Attempts (FLoRA), improving access to structured evidence on replication.
...
I will be helping to set up and support this club, with a focus on sharing best practices and encouraging reuse of simulation models and analytical code across NHS and academic settings.

### University of Exeter St Luke's coding club

March - July 2025.

I supported sessions at the coding club. This included helping participants during activities, and coordinating practical aspects such as organising food when the main organiser was unavailable.
...
The UK's annual conference for the Research Software Engineering community, focused on reproducible, sustainable, and high-quality research software.

### South West Analytics & Infrastructure in Healthcare (SWAIH) 2026

8th July 2026.

A regional conference bringing together healthcare analysts, data scientists, and infrastructure specialists to share applied work across NHS and academia.

### RPySoc 2025

13th - 14th November 2025.

The NHS-R / NHS.pycom open-source conference, centred on Python, R, and collaborative data science in healthcare.

### Simulation Workshop 2025 (SW25)

31st March - 2nd April 2025.

Conference focused on simulation modelling methods and applications across industry, defence, and healthcare.

### European Health Economics Association (EuHEA)

5th - 8th July 2022.

An international conference for health economists to present research on economic evaluation, policy, and health system performance.
...
![Spring Hackathon: Making Replications Count](munster_hackathon.jpg)

![Visiting Münster for Spring Hackathon: Making Replications Count](munster.jpg)

![EuHEA with the University of Exeter Health Economics team](euhea.jpg){width=95%}
